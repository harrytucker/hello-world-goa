...
func (m *SayHelloResponse) GetField() string {
	if m != nil {
		return m.Field
	}
	return ""
...
func init() {
	proto.RegisterType((*SayHelloRequest)(nil), "example_service.SayHelloRequest")
	proto.RegisterType((*SayHelloResponse)(nil), "example_service.SayHelloResponse")
}
...
var fileDescriptor_bdab94845fc2b7e8 = []byte{
	...
	0xc9, 0x17, 0xe2, 0x47, 0x13, 0x56, 0x12, 0xe4, 0xe2, 0x0f, 0x4e, 0xac, 0xf4, 0x48, 0xcd, 0xc9,
	0xc9, 0x0f, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x51, 0xd2, 0xe0, 0x12, 0x40, 0x08, 0x15, 0x17,
	0xe4, 0xe7, 0x15, 0xa7, 0x0a, 0x89, 0x70, 0xb1, 0xa6, 0x65, 0xa6, 0xe6, 0xa4, 0x48, 0x30, 0x2a,
	0x30, 0x6a, 0x70, 0x06, 0x41, 0x38, 0x46, 0x89, 0x5c, 0x7c, 0xae, 0x10, 0xf3, 0x82, 0x21, 0xc6,
	0x09, 0xf9, 0x73, 0x71, 0xc0, 0xf4, 0x0a, 0x29, 0xe8, 0xa1, 0xbb, 0x01, 0xcd, 0x26, 0x29, 0x45,
	0x3c, 0x2a, 0x20, 0x16, 0x3b, 0x09, 0x47, 0x09, 0xa2, 0xa9, 0x29, 0x48, 0x4a, 0x62, 0x03, 0x7b,
	0xc6, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x2d, 0xf9, 0x74, 0x81, 0xe5, 0x00, 0x00, 0x00,
}
...
func (c *exampleServiceClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/example_service.ExampleService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ExampleService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example_service.ExampleService/SayHello",
	}
