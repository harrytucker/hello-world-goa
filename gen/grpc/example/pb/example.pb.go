...
var fileDescriptor_15a1dc8d40dadaa6 = []byte{
	...
	0x2d, 0xc8, 0x49, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x87, 0x72, 0x95, 0xf8, 0xb8,
	0x78, 0x3c, 0x52, 0x73, 0x72, 0xf2, 0x83, 0x52, 0x0b, 0x4b, 0x53, 0x8b, 0x4b, 0x94, 0x54, 0xb9,
	0x78, 0xa1, 0xfc, 0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54, 0x21, 0x11, 0x2e, 0xd6, 0xb4, 0xcc, 0xd4,
	0x9c, 0x14, 0x09, 0x46, 0x05, 0x46, 0x0d, 0xce, 0x20, 0x08, 0xc7, 0xc8, 0x91, 0x8b, 0xdd, 0x15,
	0x62, 0x82, 0x90, 0x19, 0x17, 0x2b, 0x58, 0x87, 0x90, 0xa8, 0x1e, 0xcc, 0x0e, 0x64, 0x13, 0xa5,
	0xc4, 0xd0, 0x85, 0x21, 0x06, 0x3b, 0x71, 0x47, 0x71, 0x42, 0x25, 0x0a, 0x92, 0x92, 0xd8, 0xc0,
	0xce, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x40, 0x9d, 0x6c, 0xd4, 0xa7, 0x00, 0x00, 0x00,
}
...
func (c *exampleClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/example.Example/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Example_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.Example/Hello",
	}
